...
public class ServerLoadBalancerTest {
    ...
    @Test
    public void vm_shouldBeBalancedOnLessLoadedServerFirst() {
        ...
        Server lessLoadedServer = a(server().withCapacity(100)
                .withCurrentLoadOf(40.0d));
        Vm theFirstVm = a(vm().ofSize(1));
        Vm theSecondVm = a(vm().ofSize(1));
        balance(aListOfServersWith(moreLoadedServer, lessLoadedServer), aListOfVmsWith(theFirstVm, theSecondVm));

        assertThat("the lessLoadedServer should contain vm1", lessLoadedServer.contains(theFirstVm));
        assertThat("the moreLoadedServer should not contain vm1", !moreLoadedServer.contains(theFirstVm));
    }
